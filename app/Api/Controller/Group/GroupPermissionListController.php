    ...
    public function getAllPermissons($categoryIds = [], $groupPermissons = [])
    {
        $allPermissons = [
            'general' => [
                ...
                'thread.poster'     => isset($groupPermissons['thread.poster']),     // 海报
        ...
        foreach ($categoryIds as $key => $value) {
            ...
            // 海报
            if (isset($groupPermissons['thread.poster']) || isset($groupPermissons['category' . $value . '.thread.poster'])) {
                $allPermissons['thread.poster'][$value] = true;
            } else {
                $allPermissons['thread.poster'][$value] = false;
            }
