...
class FirstStatistics
{
    ...
    public function __invoke()
    {
        ...
        $overData=[];
        $overData['over']['activeUserNumToday']=User::query()->whereBetween('login_at', [$beginTime, $endTime])->count();
        $overData['over']['addUserNumToday']=User::query()->whereBetween('joined_at', [$beginTime, $endTime])->count();
        $overData['over']['addThreadNumToday']=Thread::query()->whereBetween('created_at', [$beginTime, $endTime])->count();
        $overData['over']['addPostNumToday']=Post::query()->whereBetween('created_at', [$beginTime, $endTime])->count();
    ...
    public function getWeek($startdate, $enddate)
    {
        //参数不能为空
